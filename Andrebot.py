...
class Andrebot:
    ...
    async def add(self, context, left: int, right: int):
        ...
        return await context.send(self, context)
    ...
    #self.interface.command(description="For when you wanna settle the score some other way")
    ...
    async def joined(self, context, member):
    ...
    async def repeat(self, context, times: int, content="Repetindo..."):
    ...
    async def pizza(self, context, left: int, right: int, content="Pizzaiando"):
    ...
    async def pizzahelp(self, context):
    ...
    async def sergio(self, context, description="Quantos dias faltam para SERGIO SALES"):
    ...
    async def salve(self, context, *args):
        tosend = self.emojiappended[randint(1, 409)]
        return await context.send(f"Salve pra {tosend}")


    
    async def corrige(self, context, left: int, mid: str, right: int, content="Corrigindo"):
    ...
    async def nota(self, context, n1: float, n2: float, n3: float):
    ...
    async def wordle(self, context, wordsize = 5):  
    ...
    async def sortduplas(self, context, *args):
